...
{
    public class CompletedProjectGetAllSpec : Specification<CompletedProject>
    {
        public CompletedProjectGetAllSpec(CompletedProjectFilterDTO completedProjectFilterDTO)
        {
            Query
